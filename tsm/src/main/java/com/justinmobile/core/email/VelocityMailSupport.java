 ...
 * 
 * 本类仅提供一些基本信息的配置和获取方法、veloticy模板文本生成方法、mailSender配置和获取方法 相当于一个配置简化器，不是模板模式的实现。
 * 
...
public class VelocityMailSupport implements MailSender, JavaMailSender {
	 ...
	 */
	public String renderText(Map<String, Object> model) throws VelocityException {
	 ...
	 */
	public void sendMime(String nameOfTo, String emailOfTo,
	 ...
	 *            邮件velocity模板中变量的值
	 */
	public void sendMime(String to, Map<String, Object> model)
			throws MailException {
