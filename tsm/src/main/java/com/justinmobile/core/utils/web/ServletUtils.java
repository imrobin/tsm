...
public class ServletUtils {
		...
		while (paramNames != null && paramNames.hasMoreElements()) {
			...
			if ("".equals(prefix) || paramName.startsWith(prefix)) {
				...
				if (values == null || values.length == 0) {
					...
					params.put(unprefixed, buff.toString());
				} else {
	...
	public static void sendMessage(HttpServletResponse response, String message) {
		sendMessage(response, EncodeUtils.DEFAULT_URL_ENCODING, JSON_TYPE, message);
	}
	
	public static void sendMessage(HttpServletResponse response, String encoding, String message) {
		sendMessage(response, encoding, JSON_TYPE, message);
	}
	public static void sendMessage(HttpServletResponse response, String encoding, String contentType, String message) {
