...
public interface ApplicationClientInfoDao extends EntityDao<ApplicationClientInfo, Long> {
	 ...
	 * @return
	 */
	ApplicationClientInfo getByApplicationVersionAndSysRequirmentAndFileTypeAndVersion(
	 ...
	 *            文件类型
	 */
	ApplicationClientInfo getByApplicationVersionTypeVersionFileType(ApplicationVersion applicationVersion,
