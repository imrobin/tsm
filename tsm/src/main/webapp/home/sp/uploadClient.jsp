	...
	window.addEvent("domready", function() {
		...
		$("jump").addEvent(
				...
				function(event) {
					event.stop();
					new Request.JSON({
						url : ctx + "/html/appVer/?m=completeCreateApplicationVersion",
						data : {
						...
						onSuccess : function(json) {
							if (json.success) {
								self.location.href = ctx
										+ "/home/sp/showApplicationVersionDetails.jsp?applicationVersionId=${param.applicationVersionId }";
							} else {
					...
					<div class="userinput">
						<div class="upapp_t">
							<a class="on3" title="修改基本信息可在应用上传完成后进行">输入基本信息</a> <a class="on"
								...
								href="${ctx }/home/sp/defineModuleAndApplet.jsp?applicationVersionId=${param.applicationVersionId }">定义模块和实例</a> <a class="on"
								href="${ctx }/home/sp/setOrders.jsp?applicationVersionId=${param.applicationVersionId }">配置顺序</a><a class="on2">上传客户端</a>
						</div>
						<div class="upapptext">
							<p class="left">第6 步: 上传客户端</p>
							<p class="right c_h">上传应用的客户端</p>
						</div>
						<div class="minfo">
							<div class="opertop">
								<p class="oper1">
							...
							<div id="next">
								<a class="subbutt" href="#"><span id="jump">完成</span> </a>
							</div>
						</div>
	...
	<table class="myTable">
		<tbody>
			<tr id="clientInfoTemplate" style="display: none;">
				...
				<td style="width: 20%;"><a title="下载地址" class="b">&nbsp;</a></td>
