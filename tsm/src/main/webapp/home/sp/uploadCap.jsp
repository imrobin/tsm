...
<body>
		...
		<div id="main">
			<div class="div980 line_c">
				...
				<div class="usercont">
					...
					<div class="userinput">
						<div class="upapp_t">
							<a class="on3" title="修改基本信息可在应用上传完成后进行">输入基本信息</a> <a class="on2">上传加载文件</a> <a class="on3">上传应用扩展</a> <a class="on3">定义模块和实例</a> <a
								class="on3">配置顺序</a><a class="on3">上传客户端</a>
						</div>
						<div class="upapptext">
							<p class="left">第 2步: 上传文件</p>
							<p class="right c_h">上传应用的加载文件或者选择已上传的加载文件</p>
						</div>
						<div class="minfo">
							<div class="opertop">
								<p class="oper1">
									<a class="butt2" href="#" id="requestUpload"><span><img src="${ctx }/images/uploadIcon.png" class="icon16" />上传文件</span> </a>
								</p>
							</div>
							<br />
	...
	<form id="jumpForm" action="${ctx }/home/sp/uploadExtension.jsp" style="display: none">
	...
	<table id="loadFileTemplate" style="display: none">
		<tr id="loadFileTemplateP">
			...
			<td title="操作" style="text-align: center;"><a title="引入" href="#" class="butt2" style="float: none;"><span>引入</span> </a><a
				title="升级" href="#" class="butt2" style="float: none;"><span>升级</span> </a></td>
		</tr>
	</table>
	<%--显示已上传加载文件模板结束 --%>
	<%--选择已上传加载文件版本表单模板开始 --%>
	...
	<div id="uploadDivTemplate" style="display: none">
		<form id="" title="loadFile">
			<input type="text" name="tempFileAbsPath" style="display: none" /> <input type="text" name="tempDir" style="display: none" /><input
				type="text" name="type" value="1" style="display: none" /> <input type="text" name="applicationVersionId"
