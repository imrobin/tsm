...
<script type="text/javascript">
	...
	window.addEvent('domready', function(){
		...
		$('sd').addEvent('click', function() {self.location = ctx + '/home/sp/listSubscribe.jsp';});
		
		new Application.SubscribeList();
	});
...
<div class="curPosition">您的位置: 首页&gt;我的主页&gt;订购关系&gt;应用</div>
...
<div class="userinput">
	<div id="userinput">
		<div class="titletab">
			<ul>
				<li class="s2" style="cursor: pointer;" id="sd">安全域</li>
				<li class="s1">应用</li>
			</ul>
		</div>
		<div class="minfo">
