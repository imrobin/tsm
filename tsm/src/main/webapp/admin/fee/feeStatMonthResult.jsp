	...
	<center>
		...
		<table border=0>
			...
			<c:forEach var="f" items="${function}">
			    ...
			    <tr><td width="100"></td><td width="100"></td><td width="20"></td><td width="20"></td><td>合计:0.00元</td></tr>
			    </c:when>
			    <c:otherwise>
			    <tr><td width="100"></td><td width="20"></td><td width="20"></td><td width="50"></td><td width="250">合计：${number}(人数) X ${price}(费用)==<fmt:formatNumber value="${funTotal}" type="number" pattern="￥0.00" />元</td><td width="20"></td></tr>
			    </c:otherwise>
			    </c:choose>
			    <tr></tr>
