...
<script type="text/javascript" src="${ctx}/admin/application/js/busniesstransaction.js"></script>
...
<div id="footer" class="clear"><p class="right">
Copyright©2011 Just In Mobile Corporation. All rights reserved</p></div>
</div>
<div id="requistionDiv" style="display: none;overflow-x: hidden;">
<div class="regcont" style="overflow-x: hidden;">
<form method="post">
<input name="id" type="hidden" />
<button class="validate['submit']" style="display: none;"></button>
<dl>
<dd><p class="regtext">手机号：</p><p class="left inputs">
<input id="mobileNo" class="inputtext" name="mobileNo" value=""   readonly="readonly"/></p><p class="explain left"></p></dd>
<dd><p class="regtext" id="showtype">应用名称：</p><p class="left inputs">
<input id="appName" class="inputtext" name="appName" value=""   readonly="readonly"/></p><p class="explain left"></p></dd>
<dd><p class="regtext">操作类型：</p><p class="left inputs">
<input id="procedureName" class="inputtext" name="procedureName" value=""   readonly="readonly"/></p><p class="explain left"></p></dd>
<dd><p class="regtext">承载方式：</p><p class="left inputs">
<input id="commType" class="inputtext" name="commType" type="text"  readonly="readonly"/></p></dd>
<dd><p class="regtext">当前执行顺序号：</p><p class="left inputs">
<input id="executeNo" class="inputtext" name="executeNo" type="text"   readonly="readonly"/></p></dd>
<dd><p class="regtext">失败原因：</p><p class="left inputs">
<input class="inputtext validate['required']" id="failMessage" name="failMessage" type="text"   readonly="readonly"/></p></dd>
<dd><p class="regtext">执行开始时间：</p><p class="left inputs">
<input id="beginTime" class="inputtext" name="beginTime" type="text"  readonly="readonly"/></p>
</dd>
<dd><p class="regtext">执行结束时间：</p><p class="left inputs">
<input id="endTime" name="endTime"  class="inputtext" type="text"   readonly="readonly"/></p></dd>
<dd><p class="regtext">执行结果：</p><p class="left inputs">
<input id="result" name="result"  class="inputtext" type="text"   readonly="readonly"/></p></dd>
<!--<dd><p class="regtext">会话状态：</p><p class="left inputs">
<input id="sessionStatus" name="sessionStatus"  class="inputtext" type="text"   readonly="readonly"/></p></dd>
