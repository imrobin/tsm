...
<link href="${ctx}/lib/date/DatePicker.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript" src="${ctx}/lib/menu/menu.js"></script>
<script type="text/javascript" src="${ctx}/lib/date/mootools1_2_1.DatePicker.js"></script>
<script type="text/javascript" src="${ctx}/admin/application/js/applicationSubscribe.js"></script>
<script type="text/javascript">
var ctx = '${ctx}';
window.addEvent('domready', function(){
	var appSub = new ApplicationSubscribe.list();
});
</script>
</head>
