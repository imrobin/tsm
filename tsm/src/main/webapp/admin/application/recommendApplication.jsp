...
<script type="text/javascript" src="${ctx}/admin/application/js/recommendApplication.js"></script>
        ...
        function orderCheck(el){
			if (el.value != ''){
				...
				for (var i = 0;i<no.length;i++){
					...
					if (parseFloat(str1) == parseFloat(el.value,10) && str2 == selectProvince){
...
<dl>
	<dd>
	<p class="regtext" >应用名称:</p>
	<p class="left inputs" ><select name="application.id" id="apps" class="validate['required']" style="width:400px">
	</select></p>
	</dd>
