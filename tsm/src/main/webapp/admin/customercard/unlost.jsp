...
<script type="text/javascript" src="${ctx}/admin/customercard/js/unlost.js"></script>
<script type="text/javascript">
		var ctx = '${ctx}';
        window.addEvent('domready', function(){
        	var unLost = new UnLost();
        	var gird = new JIM.UI.Grid('tableDiv2', {
    			url : ctx + '/html/customerCard/?m=listLost&search_EQI_status=2',
    			...
    			buttons : [ {
    				...
    				handler : function() {
    					...
    					new LightFace.MessageBox({
    						onClose : function() {
    							if (this.result) {
    								unLost.unLost(selectIds[0],gird);
    							}
    						}
    					}).confirm("您要解除挂失吗？");
    				}.bind(this)
