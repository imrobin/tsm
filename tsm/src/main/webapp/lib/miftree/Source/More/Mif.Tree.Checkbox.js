...
Mif.Tree.implement({
	...
	checkboxClick: function(event){
		...
		this.mouse.node['switchCheck']();
		if (this.mouse.node.state.checked == 'checked') {
			this.fireEvent('clickCheck', this.mouse.node);
		} else {
			this.fireEvent('clickUnCheck', this.mouse.node);
		}
	},
