...
<link href="${ctx}/lib/miftree/demos/checkboxsimple/demo.css" rel="stylesheet" type="text/css" />
...
<%@ include file="/lib/miftree/includeJs.jsp" %>
<script type="text/javascript" src="${ctx}/security/js/auth.js"></script>
...
<dl>
<dd><p class="regtext">权限名:</p><p class="left inputs"><input class="inputtext validate['required','%chckMaxLength','nameUpcase']" maxlength="32" name="authName" type="text" /></p></dd>
<dd><p class="regtext">描述:</p><p class="left inputs"><input class="inputtext validate['%chckMaxLength','en_cn']" maxlength="255" name="description" type="text" /></p></dd>
