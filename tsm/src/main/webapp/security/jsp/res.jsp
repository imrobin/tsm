...
<script type="text/javascript" src="${ctx}/security/js/res.js"></script>
...
<dl>
<dd><p class="regtext">链接名称:</p><p class="left inputs"><input class="inputtext validate['required','%chckMaxLength','en_cn']" maxlength="20" name="resName" type="text" /></p></dd>
<dd><p class="regtext">链接地址:</p><p class="left inputs"><input class="inputtext validate['required','%chckMaxLength','rel_url']" maxlength="255"  name="filterString" type="text" /></p></dd>
</dl>
</form>
</div>
</div>
